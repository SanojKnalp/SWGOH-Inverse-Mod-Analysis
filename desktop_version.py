...
def fetch_mod_data():
    ...
    for row in rows:
        ...
        set_names = ['critical chance' if s == 'chance' else 'critical damage' if s == 'damage' else 'defense' if s == 'defense' else s for s in set_names]
...
set_options = ["Health", "Critical Chance", "Critical Damage", "Tenacity", "Potency", "Speed", "Offense", "Defense"]
